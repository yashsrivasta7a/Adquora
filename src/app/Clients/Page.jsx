    ...
    <div className="relative w-full overflow-hidden pt-32 pb-20 bg-gradient-to-bl from-black to-gray-900">
      ...
      <div className="relative z-10 w-full max-w-screen-lg mx-auto flex flex-col items-center">
        ...
        <div className="relative w-full">
          ...
          <div className="relative bg-white backdrop-blur-sm border border-gray-200 rounded-xl p-8 shadow-2xl">
            {/* Optional: Add a subtle inner shadow for depth */}
            <div className="absolute inset-0 bg-gradient-to-b from-gray-50/50 to-white rounded-xl"></div>
